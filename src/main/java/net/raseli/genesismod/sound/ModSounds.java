package net.raseli.genesismod.sound;
...
public class ModSounds {
    ...
    private static RegistryObject<SoundEvent> registerSoundEvents(String name) {
        return SOUND_EVENTS.register(name, () -> SoundEvent.createVariableRangeEvent(ResourceLocation.tryBuild(GenesisMod.MOD_ID, name)));
    }
